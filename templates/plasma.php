<?php 
/*
Template Name: Плазменная резка
*/
get_header(); ?>
...
<main class="main">
  ...
  <section class="services page-section">
    <div class="container">
      ...
      <h2 class="title title--left">Плазменная резка</h2>

      <div class="services__text">
        <?php the_field('plasma-text'); ?>
      </div>


      <div class="technology">
        <h3 class="subtitle">
          <?php the_field('plasma-subtitle-technology'); ?>
        </h3>
    ...
    <div class="container">
      ...
      <div class="price page-section">
        ...
        <div class="price__wrapper">
          <table class="price__table" border="1">
      ...
      <div class="interesting page-section">
        ...
        <ul class="interesting__list">
          <?php
            $posts = get_posts([
              'numberposts' => -1,
              'category_name' => 'interesting-plasma',
              'post_type' => 'post',
              'suppress_filter' => true
            ]);
            foreach($posts as $post) {
